...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Mile.app  Login/input_Password_password'), 'RLBsno+vskCfjizx8EteGw==')

WebUI.click(findTestObject('Object Repository/Page_Mile.app  Login/span_Password_el-checkbox__inner'))
